...
connection1 = psycopg2.connect(host='3.108.122.116',database='landing_db',user='landing_user',password='Landing-2023',port='5432')
cursor1 = connection1.cursor()

# Establish connection to the 'staging_db' database
connection2 = psycopg2.connect(host='3.108.122.116',database='staging_db',user='staging_user',password='Staging-2023',port='5432')
...
csat_final_column=['date','lead_id','user_id','call_date','phone_number','survey_rating','user_full_name']
exportcall_list=['date','user','lead_id','full_name','call_date','status','campaign_id','query_typelevel_1','query_type_level_2','subquery_type_level_2','customer_number','call_transferred_to_survey_ivr','emp_id','phone_number','cust_talk_sec','customer_hold_time','wrap_up_time','queue_seconds']
