...
connection = psycopg2.connect(host='3.108.122.116',database='landing_db',user='landing_user',password='Landing-2023',port='5432')
...
export_url = 'http://10.1.125.41/rightside/webservices/custom_exportcall_report'
agent_url='http://10.1.125.41/rightside/webservices/custom_apr_report'
csat_url='http://10.1.125.41/rightside/webservices/agent_feedback_ivr_report'
...
def status_table_inserting(tablename, API_rows_Number):
    ...
    status_table_insert_query = f'''insert into status_ldb (table_name, json_rows, inserted_rows, db_name) values('{tablename}', {API_rows_Number[0]}, {table_row_count}, 'landing_db');'''
...
def email_notification():
    ...
    port = 587
    login = "icctestuser2023@gmail.com"  # Replace with your login email address
    password = "iulk fjgk zwlj pjsa"  # Replace with your login password
