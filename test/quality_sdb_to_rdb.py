    ...
    if count_quality_main == count_quality_temp:
        ...
        for x in pd.date_range(startdate, enddate):
            ...
            for i, row in df.iterrows():
                value = row.values
                try:
                    query = f'''INSERT INTO quality_rdb ({final_columns}) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);'''  # Insert appropriate number of placeholders
